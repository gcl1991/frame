...
@SpringApplicationContext( { "classpath:applicationContext.xml", "/web/smart-servlet.xml" ,"smart-dao.xml"})
public class LoginControllerTest extends UnitilsTestNG {
	...
	@Test
	@DataSet("Web.LoginController.xls")
	public void loginCheckByMock() throws Exception {
		...
		assertThat(user.getCredit(), greaterThan(100));
	}
